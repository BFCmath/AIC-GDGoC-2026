...
Benchmark 5 agents: rotate through 4-player groups, corners, and seeds.
  ...
  - 4 random seeds
  - Total 5 * 4 * 4 = 80 matches (each agent plays 64 matches)
...
GROUPS = [list(g) for g in itertools.combinations(range(5), 4)]
...
def run_benchmark():
    ...
    print("=" * 78)
    print(f"  5-Way v17 Rotate Benchmark  —  {total_matches} matches in parallel (max_workers=4)")
