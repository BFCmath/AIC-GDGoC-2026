...
|---|---|---|---|---|---|---|---|
| **Claude 2** | `agent/claude/2.py` | **4** | 0 | 8 | 3 | 0 | **Rất mạnh**. Đạt hiệu suất cao nhất, có khả năng cạnh tranh trực tiếp với Codex 4 và thắng áp đảo các rule agent cơ bản. |
