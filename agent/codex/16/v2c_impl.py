            ...
            if my_pos not in hyp_danger.get(1, set()):
                ...
                if can_escape:
                    ...
                    allow_bomb = (
                        ...
                        or (self.turn > 180 and post_safe >= 14 and post_frontier >= 2)
                    )
                    ...
                    if allow_bomb:
                        ...
                        if boxes_here > 0:
                            ...
                            if boxes_here == 1 and post_safe >= 5:
                                bomb_score += 90.0
                        elif self.turn > 180 and post_safe >= 14 and post_frontier >= 2:
                            bomb_score += 95.0
                            if self.turn > 320:
                                bomb_score += 70.0
                        # Conservative late-game tie-break pressure. Only applies after
                        # the economy phase and only with a large escape component.
                        if self.turn > 220 and post_safe >= 14 and post_frontier >= 2:
                            bomb_score += 35.0
                        if self.turn > 300 and post_safe >= 12:
                            bomb_score += 20.0
