...
class Agent:
    ...
    def act(self, obs: dict) -> int:
        ...
        if self._min_danger_time(my_pos, danger, horizon=10) <= 3:
            escape = self._best_escape_action(grid, my_pos, blocked_base, danger, horizon=10)
            ...
            if my_pos not in hyp_danger.get(1, set()):
                ...
                if can_escape:
                    ...
                    if self.agent_id != 0 and self.turn < 70:
                        allow_bomb = allow_bomb and (boxes_here >= 1 and post_safe >= 12 and post_frontier >= 2)
                    if allow_bomb:
                        ...
                        if boxes_here > 0:
                            bomb_score += 220.0 + 140.0 * boxes_here
